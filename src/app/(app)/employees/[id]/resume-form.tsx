...
export function ResumeForm({
  ...
  // Controlled form state to support auto-fill from uploaded resume
  ...
  const handleFileUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    startParsing(async () => {
      ...
      if (res.ok) {
        ...
        setParseStatus({
          type: "success",
          message: `Successfully extracted resume details from "${res.fileName}". Review and adjust the details below, then click "Save resume".`,
        });
      } else {
        setParseStatus({
          type: "error",
