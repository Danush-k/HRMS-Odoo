...
export function EditSalaryDrawer({
  employee,
  initialSalary,
  isOpen,
  onClose,
  ...
  // Reset values when drawer is opened for a specific employee
  useEffect(() => {
    if (isOpen) {
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-hidden">
      {/* Backdrop */}
      <div
        className="fixed inset-0 bg-ink-900/40 backdrop-blur-[2px] transition-opacity animate-in fade-in"
        onClick={onClose}
      />

      <div className="fixed inset-y-0 right-0 flex max-w-full pl-10">
        <div className="w-screen max-w-xl border-l border-line bg-surface shadow-2xl transition-all animate-in slide-in-from-right duration-200 sm:max-w-2xl flex flex-col">
          {/* Header */}
          <div className="flex items-center justify-between border-b border-line bg-surface px-6 py-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <div className="flex items-center gap-2">
                  ...
                  <span className="mono text-xs text-ink-500">({employee.loginId})</span>
                </div>
            ...
            <button
              type="button"
              onClick={onClose}
              className="rounded-lg p-2 text-ink-400 hover:bg-ink-100 hover:text-ink-800 transition"
          ...
          <form onSubmit={handleSubmit} className="flex flex-1 flex-col overflow-hidden">
            <div className="flex-1 overflow-y-auto p-6 flex flex-col gap-5">
              ...
              <div className="card p-4">
                ...
                {overAllocated ? (
                  <p className="mt-3 rounded-md border border-danger/25 bg-danger-soft px-3 py-2 text-xs font-medium text-danger">
            ...
            <div className="flex items-center justify-between border-t border-line bg-surface px-6 py-4">
              ...
              <div className="flex items-center gap-2.5">
                ...
                <button
                  ...
                  className="btn-primary btn-sm inline-flex items-center gap-1.5 shadow-xs"
                >
                  {isPending ? (
                    <>
